...
const cards: ManualCard[] = [
  ...
  },
  {
    ...
    description: 'Domina el flujo de tu programa utilizando condicionales y bucles para crear lógica compleja.',
    icon: 'account_tree',
    iconClass: 'text-tertiary',
  },
  {
    title: 'Funciones y Módulos',
    description: 'Organiza tu código escribiendo bloques reutilizables e importa librerías estándar o externas.',
    icon: 'extension',
    iconClass: 'text-primary',
  },
  {
    ...
    <main className="mx-auto max-w-[1000px] px-sm py-xl md:px-lg">
      <header className="mb-12">
        ...
        <p className="max-w-2xl text-body-lg font-body-lg text-on-surface-variant">
          Documentación técnica y guías teóricas para complementar tu aprendizaje.
        </p>
      </header>
          ...
          <a key={card.title} className="content-card group rounded-xl p-md" href="#">
            <div className="flex h-full flex-col">
              ...
              <div className="mt-6 flex items-center text-label-sm font-label-sm text-primary opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                Explorar módulo <span className="material-symbols-outlined ml-1 text-sm">arrow_forward</span>
              </div>
            </div>
          </a>
        ))}
